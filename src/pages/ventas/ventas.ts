...
import {RequestProductoPatron, ResponseListArticulotr} from "../response/response-list-articulotr";
...
import {ModalVentaPage} from "../modal-venta/modal-venta";
...
export class VentasPage implements OnDestroy, OnInit, OnChanges, DoCheck {
  txtNumMovimiento;
  txtFecha: any;
  txtCodProveedor;
  txtDescripcion;
  ...
  public infoProveedor(){
    ...
    if(this.txtCodProveedor==null?false:this.txtCodProveedor == 'undefined'?false:(this.txtCodProveedor.valueOf().length > 0)) {
      ...
      if(len == 1) {
        let _url = '/ventas/cliente/quest/' + this.txtCodProveedor;
  ...
  public infoProducto(){
    ...
    if(this.txtCodArticulo==null?false:this.txtCodArticulo == 'undefined'?false:(this.txtCodArticulo.valueOf().length > 0)) {
      ...
      console.log("len : " + len);
      if(len == 1) {
        let _url = '/ventas/articulo/quest/' + this.txtCodArticulo;
  ...
  public listaProveedores() {
    ...
    //loading.present();
    var urlListaProveedor = '/ventas/cliente/list';
  ...
  public obtenerArticulo() {
    ...
    loading.present();
    var urlListaProveedor = '/ventas/articulo/quest/' + this.txtCodArticulo;
  ...
  public listaExistenciasArticulos() {
    ...
    loading.present();
    var urlListaProveedor = '/ventas/articulo/' + this.txtCodArticulo + '/existence';
  ...
  public listaArticulos() {
    ...
    loading.present();
    var urlListaProveedor = '/ventas/articulo/list';
    this.sicService.getGlobal<ResponseListArticulotr>(urlListaProveedor).subscribe(
      data => {
        loading.dismiss();
        let alert = this.alertCtrl.create();
  ...
  public crearPedido() {
    ...
    //loading.present();
    var urlListaProveedor = '/ventas/add';
  ...
  public detallePedidos() {
    ...
    loading.present();
    var urlListaProveedor = '/ventas/list';
    this.sicService.getGlobal<ResponseListPedidos>(urlListaProveedor).subscribe(
      data => {
        ...
        if (data.respuesta) {
          ...
          this.navCtrl.push(ModalVentaPage, {
  ...
  public detalleLlegadas() {
    ...
    loading.present();
    var urlListaProveedor = '/ventas/llegada/list';
    this.sicService.getGlobal<ResponseListPedidos>(urlListaProveedor).subscribe(
      data => {
        console.log(data);
        loading.dismiss();
