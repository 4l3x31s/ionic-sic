...
/**
 * Generated class for the ModalRecibidoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-modal-recibido',
  templateUrl: 'modal-recibido.html',
})
export class ModalRecibidoPage {
  ...
  public eliminarPedido(){
    ...
    loading.present();
    var id = this.idPedido + '';
    var url = '/transferencia/recibir/cancelar/recepcion/';
  ...
  public detallarPedidos(){
    console.log("Ingresa detallar pedidos")
    const loading = this.loadingCtrl.create({
      content: 'Listando Productos'
    });
    loading.present();
